...
<div class="stages-timeline-section" v-show="activeCardId === 'overview' || activeCardId === 'foundation'">
      ...
      <div v-if="showRadarModal" class="modal-overlay" @click.self="showRadarModal = false">
        <div class="modal-card">
          <div class="modal-header">
            ...
            <button class="modal-close" type="button" @click="showRadarModal = false">&#x2715;</button>
          </div>
      ...
      <div v-if="showMonthlyModal" class="modal-overlay" @click.self="showMonthlyModal = false">
        <div class="modal-card modal-card-wide">
          <div class="modal-header">
            ...
            <button class="modal-close" type="button" @click="showMonthlyModal = false">&#x2715;</button>
          </div>
          <div class="modal-body">
            <div class="gantt-section" v-if="learningPath.monthlyPlan && learningPath.monthlyPlan.length > 0">
              <div class="section-header">
                <h2 class="section-title">
                  <svg class="section-icon-svg" viewBox="0 0 24 24" aria-hidden="true"><rect x="3" y="5" width="18" height="16" rx="3" fill="none" stroke="currentColor" stroke-width="2" /><rect x="3" y="9" width="18" height="2" fill="currentColor" /><rect x="7" y="3" width="2" height="4" fill="currentColor" /><rect x="15" y="3" width="2" height="4" fill="currentColor" /></svg>
                  &#x6708;&#x5EA6;&#x5B66;&#x4E60;&#x8BA1;&#x5212;
                </h2>
                ...
                <div class="gantt-chart">
                  ...
                  <div v-for="task in flattenedTasks" :key="task.id" class="gantt-row">
                    ...
                    <div class="gantt-timeline">
                      ...
                      >
                        <span class="gantt-bar-label">{{ task.duration || 1 }}{{ weekUnit }}</span>
                      </div>
                    </div>
                  </div>
                </div>
