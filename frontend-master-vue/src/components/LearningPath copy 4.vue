<template>
  <div class="learning-path-container">
    ...
    <div class="assessment-section" v-if="!hasAssessment">
      <div class="assessment-card" ref="assessmentCardRef">
        ...
        <div class="assessment-content">
          ...
          <!-- 一、基本信息 -->
          <div class="form-section" ref="basicInfoRef">
          ...
          <!-- 二、学习目标 -->
          <div class="form-section" ref="goalsRef">
            <h3 class="section-title">
          ...
          <!-- 四、技能自评 -->
          <div class="form-section" ref="skillsRef">
            <h3 class="section-title">
    ...
    <div class="learning-path-section" v-if="hasAssessment && learningPath">
      ...
      <!-- Summary概览卡片 -->
      <div class="summary-overview" v-if="learningPath.summary">
      ...
      <!-- 学习阶段横向时间轴 -->
      <div class="stages-timeline-section">
        <div class="section-header">
          <h2 class="section-title">
            <span class="section-icon">🎯</span>
            学习阶段总览
      ...
      <!-- 项目阶梯图 -->
      <div class="project-ladder-section" v-if="learningPath.projects && learningPath.projects.length > 0">
        <div class="section-header">
          <h2 class="section-title">
            <span class="section-icon">🎯</span>
            项目实战路线
